...
const NFTCard = ({nftData}) => {
    ...
    // const cardArray = [
    //         image.nftsale1, image.nftsale2, image.nftsale3, image.nftsale4,
    //         image.nftsale5, image.nftsale6, image.nftsale7, image.nftsale8,
    //     ];
        ...
        {nftData.map((el, i)=>(
            ...
            <div className={Style.NFTCard_box} key={i + 1}>
                <div className={Style.NFTCard_box_img}>
                    <Image src={el.image} alt="NFT Image" width={600} height={600} 
                    className={Style.NFTCard_box_img_img}/>
                </div>
                <div className={Style.NFTCard_box_update}>
                    <div className={Style.NFTCard_box_update_left}>
                        <div className={Style.NFTCard_box_update_left_like} onClick={()=>likeNft()}>
                            {like ? (<AiOutlineHeart/>) : (<AiFillHeart className=
